...
<template>
    ...
    <div class="flex flex-col" ref="animatedPage" v-show="!isDataLoading">
        <div class="grow home flex flex-col gap-y-8" v-if="isFullData">
            <div
                class="home__photo photo self-center flex justify-center items-center w-full max-w-[400px] h-[75vw] max-h-[320px] mt-[-1.5rem] mx-[-3vw] pt-6 gradient-primary rounded-b-3xl">
